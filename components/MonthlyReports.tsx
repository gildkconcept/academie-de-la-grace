...
export const MonthlyReports = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Header avec sélecteurs - Version responsive */}
      ...
      {/* Panneau filtres - Version responsive */}
      {showFilters && (
      ...
      {/* Cartes statistiques - Version responsive */}
      ...
      {/* Graphiques - Version mobile optimisée */}
      ...
      {/* Barre de taux - Version simplifiée mobile */}
      <div className="bg-white/[0.06] backdrop-blur-2xl border border-white/[0.1] rounded-xl p-3 sm:p-4">
